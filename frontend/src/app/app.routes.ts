...
import { VerifySuccesComponent } from './pages/verify-succes/verify-succes.component';
...
export const routes: Routes = [
  ...
  {path: "verify-success", component: VerifySuccesComponent, title: "Compte vérifié  | Knowledge Learning"},
];
